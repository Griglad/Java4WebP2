...
#11Apmt
insert into appointment values(11,'2018-12-20 17:50','Νευρα ανευ αιτίας','Νέυρα',2,3)

#12Αptm
insert into appointment values(12, '2019-01-15 19:20', 'Αρτηριοσκληρηνση', 'Ενοχλήσεις', 5, 2)
#13Aptm
insert int appointment values(13, '2020-01-15 16:40', 'Καρδιολογικος ελεγχος','check up',2,1)
#14Aptm
insert into appointment values(14, '2018-30-12 19:20', 'Ταχυκαρδία', 'Καρδιογράφημα', 2, 5)
#15Aptm
